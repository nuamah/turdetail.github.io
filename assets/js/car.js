document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById('savedCarsHeader').addEventListener('click', function() {
    var icon = document.getElementById('arrowIcon');
    if (icon.getAttribute('src') === './assets/images/icons/arrow-up.png') {
      icon.setAttribute('src', './assets/images/icons/arrow-down.png');
    } else {
      icon.setAttribute('src', './assets/images/icons/arrow-up.png');
    }
  });